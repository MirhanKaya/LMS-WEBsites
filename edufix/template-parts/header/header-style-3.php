...
<header id="masthead" class="site-header header-3 header-width<?php echo esc_attr($header_classes); ?>"
            ...
            <div class="topbar-wrap-layout">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <div class="topbar-right justify-content-start  align-items-center">
                                <ul class="topbar-list">

                                    <?php if (!empty(edufix_option('header_gmail'))) : ?>
                                        <li>
                                            <div class="topbar-info">
                                                <i class="<?php echo esc_attr(edufix_option('gmail_icon')); ?>"></i>
                                                <a href="mailto:<?php echo esc_html(edufix_option('header_gmail')); ?>"><?php echo esc_html(edufix_option('header_gmail')); ?></a>
                                            </div>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (!empty(edufix_option('header_address'))) : ?>
                                        <li>
                                            <div class="topbar-info">
                                            <i class="<?php echo esc_attr(edufix_option('address_icon')); ?>"></i>
                                                <?php echo edufix_option('header_address'); ?>
                                            </div>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (!empty(edufix_option('phone_number'))) : ?>
                                        <li>
                                            <div class="topbar-info">
                                                <i class="<?php echo esc_attr(edufix_option('phone_icon')); ?>"></i>
                                                <a href="tel:<?php echo esc_html(edufix_option('phone_number')); ?>"><?php echo esc_html(edufix_option('phone_number')); ?></a>
                                            </div>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                        ...
                        <div class="col-lg-4">
                            <div class="topbar-right d-block text-right">
                                <?php
        ...
        <div class="container">
            <div class="header-inner">
                <nav id="site-navigation" class="main-nav">
                    ...
                    <?php
                    $contact_icon = !empty(edufix_option('contact_icon')) ? "<i class='". edufix_option('contact_icon') . "'></i>" : '';
                    // $contact_title = edufix_option('contact_title');
                    $contact_number = edufix_option('contact_number'); ?>

                    <div class="nav-right">
                        <?php get_search_form(); ?>
                        <div class="header-contact">
                            <div class="contact-icon">
                                <a href="tel:<?php echo $contact_number; ?>"><?php echo $contact_icon; ?></a>
                            </div>
                        </div>
